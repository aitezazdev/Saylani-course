...
const DataScience = ({dataScienceBlogs}) => {
    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {dataScienceBlogs.map((blog) => (
          ...
          >
            <div className="h-40 bg-gradient-to-r from-blue-500 to-indigo-300 flex items-center justify-center">
            ...
            <div className="p-6">
              ...
              <span className="text-blue-600 font-semibold hover:underline cursor-pointer">READ MORE »</span>
            </div>
